...
class UpdatePlugin(Screen, ProtectedScreen):
	...
	def checkTraficLight(self):
		...
		url = "https://openfix.tv/trafficlight"
		...
		# or display a generic warning if fetching failed
			...
			message = _("The status of the current image could not be checked because %s can not be reached.") % ("openfix.tv")
